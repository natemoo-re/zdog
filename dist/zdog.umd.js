...
(function (global, factory) {
  ...
  (global = global || self, global.Zdog = factory());
  ...
  const easeInOut = function(alpha, power) {
    if (power == 1) {
      return alpha;
    }
  ...
  extend(Illustration.prototype, Dragger.prototype);
  ...
  Hemisphere.prototype.getDomeRenderElement = function(ctx, renderer) {
    ...
    if (!this.domeSvgElement) {
      // create svgElement
      this.domeSvgElement = document.createElementNS(svgURI$1, "path");
  ...
  var svgURI$2 = "http://www.w3.org/2000/svg";
  ...
  CylinderGroup.prototype.getRenderElement = function(ctx, renderer) {
    ...
    if (!this.svgElement) {
      // create svgElement
      this.svgElement = document.createElementNS(svgURI$2, "path");
    }
    return this.svgElement;
  };
  ...
  var svgURI$3 = "http://www.w3.org/2000/svg";
  ...
  Cone.prototype.getSurfaceRenderElement = function(ctx, renderer) {
    ...
    if (!this.surfaceSvgElement) {
      // create svgElement
      this.surfaceSvgElement = document.createElementNS(svgURI$3, "path");
